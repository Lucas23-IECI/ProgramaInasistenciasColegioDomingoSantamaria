...
const tasks = [
  ...
  ['Seguimiento institucional', 'Pruebas unitarias, API, UI y regresión', 'Codex (local)', 'Complete', 'P0', d(14), d(15)],
...
sheet.getRange('B10:H37').values = tasks;
sheet.getRange('G10:H37').format.numberFormat = 'dd-mmm-yyyy';
...
sheet.getRange('B41:AD42').values = [[
  'Estado local al 09-08-2026: implementación y QA automatizada completas. Quedan únicamente la validación escolar de reglas automáticas y la aprobación institucional de retención del chat. La automatización permanece desactivada por defecto.',
  ...Array(28).fill('')
], Array(29).fill('')];
